...
describe('Escrow', () => {
    ...
    beforeEach(async () => {
        ...
        let transaction = await realEstate
            .connect(seller)
            .mint("https://ipfs.io/ipfs/bafybeifx7yeb55armcsxwwitkymga5xf53dxiarykms3ygqic223w5sk3m#x-ipfs-companion-no-redirect");
    ...
    describe('Desposit', () => {
        it('Update contract balance', async () => {
            const transaction = await escrow.connect(buyer)
                .depositEarnest(
                    1,
                    {
                        value: tokens(5)
    ...
    describe('Sale', async () => {
        beforeEach( async () => {
            ...
            transaction = await escrow.connect(inspector).updateInspectionStatus(1,
                {
                    value: tokens(5)
                }
            )
